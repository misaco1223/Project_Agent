...
自然言語による依頼を受け、プロジェクトのタスク情報やGitHub Issueを確認し、プロジェクトの進捗状況やスケジュールリスクを確認できるCLI型のAIエージェントです。
...
のような案内や対応案は回答に含まないようにしています。

---

### 4. 進捗更新にはユーザーの承認が必要

進捗更新を依頼された場合でも、すぐには更新処理を実行せず、ユーザーの承認を明確に得てから更新するようにしています。

Agentの判断だけでプロジェクトデータが変更されることを防いでいます。
